...
using Coevery.Themes.Handlers;
using Coevery.Themes.Models;
using Coevery.Themes.Services;
using Coevery.UI.Notify;

namespace Coevery.Tests.Modules.Themes.Services {
#if REFACTORING
    [TestFixture, Ignore]
    public class ThemeServiceTests {
        ...
        public void Init() {
            ...
            builder.RegisterType<Coevery.Localization.Text>().As<IText>();
