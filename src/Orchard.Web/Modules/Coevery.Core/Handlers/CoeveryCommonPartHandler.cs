...
namespace Coevery.Core.Handlers {
    ...
    public class CoeveryCommonPartHandler : ContentHandler {
        ...
        public CoeveryCommonPartHandler(
            ...
            OnUpdateEditorShape<CoeveryCommonPart>(AssignUpdateUser);
            OnUpdateEditorShape<CoeveryCommonPart>(AssignUpdateDates);
        ...
        protected void AssignCreatingOwner(InitializingContentContext context, CoeveryCommonPart part) {
        ...
        protected void AssignCreatingDates(InitializingContentContext context, CoeveryCommonPart part) {
        ...
        private void AssignUpdateUser(UpdateEditorContext context, CoeveryCommonPart part) {
            part.Modifer = _authenticationService.GetAuthenticatedUser();
        }

        private void AssignUpdateDates(UpdateEditorContext context, CoeveryCommonPart part) {
            var utcNow = _clock.UtcNow;
            part.ModifiedUtc = utcNow;
            part.VersionModifiedUtc = utcNow;
        }
