...
function OptionItemsCtrl($rootScope, $scope, logger, $detour, $resource, $stateParams) {
    var optionItemsDataService = $resource('api/optionset/OptionItem',
        {},
        { update: { method: 'PUT' } });
    ...
    $scope.deleteItem = function() {
        ...
        optionItemsDataService.delete({ Id: $scope.itemId }, function() {
            $scope.getOptionItems();
    ...
    $scope.getOptionItems = function() {
        var items = optionItemsDataService.query({ setId: $scope.optionSetId }, function() {
