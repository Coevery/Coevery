...
angular.module("ngGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("footerTemplate.html",
      ...
      "<div class=\"dataTables_info\" id=\"demo-dtable-03_info\">Showing {{(pagingOptions.currentPage -1)*pagingOptions.pageSize + 1}} to " +
      ...
      "of {{pagingOptions.totalServerItems}} entries</div>" +
      "</div><div class=\"span6\"><div class=\"dataTables_paginate paging_bootstrap pagination\">" +
      "<ul><li ng-class=\"{'prev disabled': pagingOptions.currentPage == pagingOptions.pageNumber[0]}\"><a href=\"#\" ng-click=\"pageBackward()\">← Previous</a></li>" +
      ...
      "<li class=\"next\" ng-class=\"{'prev disabled': pagingOptions.currentPage == pagingOptions.pageNumber[pagingOptions.pageNumber.length-1]}\"><a href=\"#\" ng-click=\"pageForward()\">Next → </a></li></ul></div></div></div></div>"
