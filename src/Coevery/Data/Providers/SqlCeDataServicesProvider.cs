...
namespace Coevery.Data.Providers {
    public class SqlCeDataServicesProvider : AbstractDataServicesProvider {
        ...
        public SqlCeDataServicesProvider(string dataFolder, string connectionString) {
            ...
            _fileName = Path.Combine(_dataFolder, "Coevery.sdf");
        }
        ...
        public override IPersistenceConfigurer GetPersistenceConfigurer(bool createDatabase) {
            ...
            persistence = persistence.Driver(typeof(CoeverySqlServerCeDriver).AssemblyQualifiedName);
            return persistence;
        }
        ...
        public class CoeverySqlServerCeDriver : SqlServerCeDriver {
