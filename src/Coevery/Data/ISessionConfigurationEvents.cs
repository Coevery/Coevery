...
namespace Coevery.Data {
    ...
    public interface ISessionConfigurationEvents : ISingletonDependency {
        ...
        /// before applying any default Coevery config settings (alterations, conventions etc.).
        /// </summary>
        ...
        /// Otherwise the cached configuration (mappings.bin file) will be used as long as default Coevery configuration 
