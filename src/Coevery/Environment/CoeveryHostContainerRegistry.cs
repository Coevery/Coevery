...
namespace Coevery.Environment {
    /// <summary>
    /// Provides ability to connect Shims to the CoeveryHostContainer
    /// </summary>
    public static class CoeveryHostContainerRegistry {
        private static readonly IList<Weak<IShim>> _shims = new List<Weak<IShim>>();
        private static ICoeveryHostContainer _hostContainer;
        ...
        public static void RegisterHostContainer(ICoeveryHostContainer container) {
            lock (_syncLock) {
                CleanupShims();
