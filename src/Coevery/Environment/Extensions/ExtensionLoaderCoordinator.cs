    ...
    public class ExtensionLoaderCoordinator : IExtensionLoaderCoordinator {
        ...
        private ExtensionLoadingContext CreateLoadingContext() {
            ...
            if (duplicates.Any()) {
                ...
                sb.Append(T("There are multiple extensions with the same name installed in this instance of Coevery.\r\n"));
                ...
                throw new CoeveryException(new LocalizedString(sb.ToString()));
            }
