...
namespace Coevery.Environment {
    ...
    public class DefaultCoeveryHostContainer : ICoeveryHostContainer, IDependencyResolver {
        private readonly IContainer _container;


        public DefaultCoeveryHostContainer(IContainer container) {
        ...
        TService ICoeveryHostContainer.Resolve<TService>() {
