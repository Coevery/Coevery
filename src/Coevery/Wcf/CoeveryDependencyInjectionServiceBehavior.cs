...
namespace Coevery.Wcf {
    public class CoeveryDependencyInjectionServiceBehavior : IServiceBehavior {
        private readonly IWorkContextAccessor _workContextAccessor;
        private readonly Type _implementationType;
        private readonly IComponentRegistration _componentRegistration;

        public CoeveryDependencyInjectionServiceBehavior(IWorkContextAccessor workContextAccessor, Type implementationType, IComponentRegistration componentRegistration) {
        ...
        public void ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase) {
            ...
            CoeveryInstanceProvider provider = new CoeveryInstanceProvider(this._workContextAccessor, this._componentRegistration);
