...
namespace Coevery.Core.Settings.Tokens {
    ...
    public class SettingsTokens : ITokenProvider {
        ...
        public SettingsTokens(ICoeveryServices coeveryServices, IContentDefinitionManager contentDefinitionManager) {
        ...
        public void Evaluate(dynamic context) {
            var forContent = context.For<ISite>("Site", (Func<ISite>)(() => _coeveryServices.WorkContext.CurrentSite));
