...
namespace Coevery.Users.Services {
    ...
    public class MembershipService : IMembershipService {
        ...
        public MembershipService(ICoeveryServices coeveryServices, IMessageManager messageManager, IEnumerable<IUserEventHandler> userEventHandlers, IClock clock, IEncryptionService encryptionService) {
