...
namespace Coevery.Workflows.Tokens {
            ...
            context.For<WorkflowContext>("Workflow")
                   .Token(
                       ...
                       (token, workflowContext) => {
                           ...
                           var url = "~/Coevery.Workflows/Signal/Trigger?nonce=" + HttpUtility.UrlEncode(_signalService.Value.CreateNonce(contentItemId, token));
