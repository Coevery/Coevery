...
namespace Coevery.Projections.FilterEditors.Forms {
    public class OrchardDateTimeFilterForm : IFormProvider {
        ...
        public OrchardDateTimeFilterForm(IShapeFactory shapeFactory, Work<IResourceManager> resourceManager) {
        ...
        public void Describe(DescribeContext context) {
            Func<IShapeFactory, object> form =
                shape => {
                    ...
                    _resourceManager.Value.Include("script", "~/Modules/Coevery.Orchard.Projections/Scripts/datetime-editor-filter.js", "~/Modules/Coevery.Orchard.Projections/Scripts/datetime-editor-filter.js");
                    _resourceManager.Value.Include("stylesheet", "~/Modules/Coevery.Orchard.Projections/Styles/datetime-editor-filter.css", "~/Modules/Coevery.Orchard.Projections/Styles/datetime-editor-filter.css");
