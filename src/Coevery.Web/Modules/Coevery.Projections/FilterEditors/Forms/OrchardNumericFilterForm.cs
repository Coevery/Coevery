...
namespace Coevery.Projections.FilterEditors.Forms {
    public class OrchardNumericFilterForm : IFormProvider {
        ...
        public OrchardNumericFilterForm(IShapeFactory shapeFactory, Work<IResourceManager> resourceManager) {
        ...
        public void Describe(DescribeContext context) {
            Func<IShapeFactory, object> form =
                shape => {
                    ...
                    _resourceManager.Value.Include("script", "~/Modules/Coevery.Orchard.Projections/Scripts/numeric-editor-filter.js", "~/Modules/Coevery.Orchard.Projections/Scripts/numeric-editor-filter.js");
