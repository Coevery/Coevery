...
namespace Coevery.Widgets.Filters {
    public class WidgetFilter : FilterProvider, IResultFilter {
        ...
        public void OnResultExecuting(ResultExecutingContext filterContext) {
            ...
            IEnumerable<LayerPart> activeLayers = _coeveryServices.ContentManager.Query<LayerPart, LayerPartRecord>().List();
            ...
            foreach (var widgetPart in widgetParts) {
                ...
                // check permissions
                if (!_coeveryServices.Authorizer.Authorize(Core.Contents.Permissions.ViewContent, widgetPart)) {
                    continue;
                }

                var widgetShape = _coeveryServices.ContentManager.BuildDisplay(widgetPart);
