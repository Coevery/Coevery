...
using Coevery.ContentPicker.Settings;
using Coevery.Localization;
using Coevery.UI.Navigation;

namespace Coevery.ContentPicker.Services {
    public class ContentPickerNavigationProvider : INavigationProvider {
        ...
        public void GetNavigation(NavigationBuilder builder) {
            ...
            builder.Add(T("Content Picker"),
                menu => menu
                    .Add(T("Recent Content"), "5", item => item.Action("Index", "Admin", new { area = "Coevery.ContentPicker" }).LocalNav()));
